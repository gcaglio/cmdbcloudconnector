...
fwrite($f_reserv_output,"Code;Description;Id;AzName;Name;Location;Scope;Type;Quantity;SkuName;SkuDescription;Flexibility;Autorenew;BillingScope;Billing;Expiration;Archived\r\n");
  ...
  if ( $subs_json_obj[$s]->{"state"} === "Enabled" ){
    ...
    for ($v=0; isset($ro_json_obj->{"reservationOrderIds"}->{"value"}) && $v<count($ro_json_obj->{"reservationOrderIds"}->{"value"}); $v++){
      ...
      for ($r=0;  $r<count($ri_json_obj);  $r++){
        ...
        $line=$hash_resid.";".$res_displayname.";".$res_id.";".$res_name.";".$res_displayname.";".$res_location.";".$res_scope.";".$res_type.";".$res_qty.";".$res_skuname.";".$res_skudescription.";".$res_flexi.";".$res_autorenew.";".$res_billingscope.";".$res_billing.";".$res_expiration.";".$res_archived."\r\n";
